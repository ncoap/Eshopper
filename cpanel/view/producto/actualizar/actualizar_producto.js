angular.module('odisea.producto.actualizar',
    ...
    .controller('productoUpController', function (utilFactory, $state, $rootScope, $window, $scope, $log, $http, $modal, $timeout, dialogs) {
